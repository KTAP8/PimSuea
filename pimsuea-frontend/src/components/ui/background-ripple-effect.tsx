...
export const BackgroundCells = ({ children, className }: BackgroundCellsProps) => {
  return (
    <div className={cn("relative h-screen flex flex-col items-center justify-center overflow-hidden bg-white", className)}>
      <BackgroundCellCore />
      {children && (
          ...
          {row.map((_, colIdx) => {
            ...
            return (
              <div
                ...
                className={cn(
                  "bg-transparent border-l border-b border-gray-200",
                  cellClassName
                )}
              ...
              >
                <motion.div
                  ...
                  animate={controls}
                  className="bg-[#07636D]/30 h-12 w-12"
                />
              </div>
            );
          })}
